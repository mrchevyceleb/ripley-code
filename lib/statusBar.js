...
class StatusBar {
  ...
  _applyScrollRegion() {
    ...
    // Anchor input/output cursor at the bottom of the scrollable region.
  ...
  _renderBar() {
    ...
    // Do not clear the spacer row here: when long prompts wrap,
    // that row can temporarily hold part of the input line.
    let paint = '\x1b[s';
    paint +=

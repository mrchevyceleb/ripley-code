 ...
 * Visual rendering is handled in ripley.js via the keypress event loop:
...
class InlineComplete {
  ...
  /**
   * Store ghost text suggestion. Visual rendering is done by ripley.js.
  ...
  /**
   * Clear the ghost text state. Terminal cleanup is done by ripley.js prependListener.
   */
  clearGhost() {
    this.currentGhost = '';
  }

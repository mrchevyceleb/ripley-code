# Banana Code Overview

Banana Code is a local AI coding agent CLI that connects directly to LM Studio. Users run `banana` in their project directory.
...
- **Project instructions**: `BANANA.md` at project root for per-project AI customization
...
- `project-instructions` - BANANA.md setup and usage
